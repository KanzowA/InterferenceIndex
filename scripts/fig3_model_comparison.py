...
Usage:
    ...
    python scripts/fig3_model_comparison.py --out figures/figure3_model_comparison.pdf
"""
...
def plot(by_model: dict, models: list, out_path: str):
    ...
    n_cols  = min(len(models_present), 3)
    ...
    # Hide unused panels
    for idx in range(len(models_present), n_rows * n_cols):
...
def main():
    ...
    parser.add_argument("--csv",    default="results/2020/interference_scores_2020.csv")
    parser.add_argument("--models", nargs="+", default=DEFAULT_MODELS)
    parser.add_argument("--out",    default="figures/figure3_model_comparison.pdf")
