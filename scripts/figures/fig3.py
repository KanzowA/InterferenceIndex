"""Figure 3: gradient descent fields in 2D residual space (N = 2).

    (a) the MSE descent direction
    (b) the xi^2 descent direction
"""
...
def build_figure():
    ...
    # -- Arrow grids - left panel (10x10), right panel (13x13) ------------
...
def main():
    ...
    parser.add_argument("--out", default=os.path.join(REPO_ROOT, "figures", "figure3.png"))
